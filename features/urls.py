...
from .views import get_features, feature_description, new_feature, edit_feature, delete_feature, add_feature_comment, edit_feature_comment, delete_feature_comment
...
urlpatterns = [
    ...
    path('<int:pk>/delete_feature/', delete_feature, name="delete_feature"),
