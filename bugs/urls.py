...
from .views import show_bugs, bug_description, add_bug, delete_bug, edit_bug, add_bug_comment, edit_bug_comment, delete_bug_comment
...
urlpatterns = [
    ...
    path('<int:pk>/delete_bug/', delete_bug, name="delete_bug"),
